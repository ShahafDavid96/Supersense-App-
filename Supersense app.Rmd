...
DT_data<-full_join(func_data,find_usefull,by="user_pseudo_id")
DT_data<-reg_data[c("num_of_read_uses","num_of_find_uses","num_of_explore_uses","answer")]

reg_data$answer[DT_data$answer=="not sure"]<-"no"
new_df <- na.omit(DT_data, "answer")
```
